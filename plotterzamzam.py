...
# Constants
hashlist = "zamzamcleartext.txt"
rockyoupcfg = "Largerockyou.txt"  # PCFG Rockyou list of length end_loop - step
rockyou = "rockyou.txt"
wordlist = "zamzamscrape.txt"
llamalist = "zamzamllama3110000.txt"
philist = "zamzamphi4.txt"
hashcat_mode = "99999"
attack_mode = "0"
outfile = "cracked.txt"
plot_filename = "zamzamcombirockyouscrapellamaphi.png"  # The saved plot filename
rule_name = "OneRuleToRuleThemStill.rule"
N = 15960 # Lengte van woordnelijst
...
plt.title("Hashcat cracking performance for multiple methods for the Zamzamdirect leak")
plt.grid(True)
plt.legend()
