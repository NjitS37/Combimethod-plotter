...
# Constants
hashlist = "battlefieldcleartext.txt"
rockyoupcfg = "Largerockyou.txt"  # PCFG Rockyou list of length end_loop - step
rockyou = "rockyou.txt"
wordlist = "battlefieldscrape.txt"
llamalist = "battlefieldllamafulllist.txt"
philist = "Battlefieldphi4.txt"
hashcat_mode = "99999"
attack_mode = "0"
outfile = "cracked.txt"
plot_filename = "battlefieldcombirockyouscrapellamaphi.png"  # The saved plot filename
rule_name = "OneRuleToRuleThemStill.rule"
N = 420635 # Lengte van woordnelijst
...
plt.title("Hashcat cracking performance for multiple methods for the battlefield leak")
plt.grid(True)
plt.legend()
